...
assert.strictEqual(M.storageKind({ backend: "s3", preset: "aws" }), "AWS S3");
assert.strictEqual(M.storageKind({ backend: "s3", preset: "r2" }), "Cloudflare R2");
assert.strictEqual(M.storageKind({ backend: "s3", preset: "minio" }), "MinIO");
